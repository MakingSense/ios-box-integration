...
#import "MSLibraryAssetCCollectionViewController.h"
#import "MSFolderTableViewController.h"
#import "MSFileDetailsTableViewController.h"
#import "MSProgressView.h"

@interface MSFolderTableViewController ()
...
@implementation MSFolderTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MSItemTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:UserTableViewCellIdentifier];
    
    if (cell == nil) {
        cell = [[MSItemTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:UserTableViewCellIdentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([item isKindOfClass:[BOXFolder class]]) {
        controller = [[MSFolderTableViewController alloc] initWithClient:self.client folderID:((BOXFolder *)item).modelID];
    } else {
        controller = [[MSFileDetailsTableViewController alloc] initWithClient:self.client itemID:item.modelID itemType:item.type];
    }
...
- (void)importAction:(id)sender
{
    ...
    __weak MSFolderTableViewController *weakSelf = self;
    
    UICollectionViewFlowLayout *layout = [[UICollectionViewFlowLayout alloc] init];
    layout.scrollDirection = UICollectionViewScrollDirectionVertical;
    MSLibraryAssetCCollectionViewController *libraryAssetViewController = [[MSLibraryAssetCCollectionViewController alloc] initWithCollectionViewLayout:layout];
